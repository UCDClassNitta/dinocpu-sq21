...
You can extend your work from [Project 1](./assignment-1.md), or you can take the updated code from [GitHub](https://github.com/UCDClassNitta/dinocpu-sq21/).
...
You will upload the three files that you changed to Gradescope on the [Project 2](https://www.gradescope.com/courses/258436/assignments/1162816) assignment.
...
- Start early! There is a steep learning curve for Chisel, so start early and ask questions on [Piazza](https://piazza.com/class/kmuxvwwkkyj5r1) and in discussion.
- If you need help, come to office hours, or post your questions on [Piazza](https://piazza.com/class/kmuxvwwkkyj5r1).
