...
Modified for ECS 154B Lab 1, Winter 2021.

**Due on 4/12**: See [Submission](#submission) for details
...
However, if you run into any problems, post on [Piazza](https://piazza.com/ucdavis/spring2021/ecs154b/home) or come to office hours.
...
You can find the code for this program in [`src/test/resources/risc-v/add1.riscv`](https://github.com/UCDClassNitta/dinocpu-sq21/blob/main/src/test/resources/risc-v/add1.riscv) and below:
...
You can see this on line 70 in [`src/test/scala/labs/Lab1Test.scala`](https://github.com/UCDClassNitta/dinocpu-sq21/blob/main/src/test/scala/labs/Lab1Test.scala).
...
Upload your diagram to this [Canvas assignment](https://canvas.ucdavis.edu/courses/577427/assignments/678790).
